...
namespace Teeths
{
    public partial class JawModel : Form
    {
        private int _id;
        public JawModel(int id)
        {
            InitializeComponent();
            _id = id;
        ...
        {
            Form _teethInfo = new TeethInfo(number, _id);
            _teethInfo.ShowDialog();
        ...
        private void linkLabel34_LinkClicked_1(object sender, LinkLabelLinkClickedEventArgs e)
        {
            LinkLabel lnk = (LinkLabel)sender;
            this.InputTeethInfo(lnk.Text);
        }
